...
public interface Repository {
    ...
    int createMovie(Film article) throws Exception;
    ...
    List<Director> selectDirector(Film movie) throws Exception;
    ...
    List<Actor> selectActor(Film movie) throws Exception;
    ...
    List<Genre> selectGenre(Film movie) throws Exception;
    ...
    void deleteAllPersons() throws Exception;
